...
start_epoch = 30.75 * constants.JULIAN_YEAR
end_epoch = 35.73 * constants.JULIAN_YEAR
mid_epoch = (2463721.5 - 2451545.0) * 86400.0

start_epoch_juice = 32.0 * constants.JULIAN_YEAR
start_orbital_phase = 34.967 * constants.JULIAN_YEAR
end_epoch_juice = 35.73 * constants.JULIAN_YEAR

start_epoch_clipper = 30.75 * constants.JULIAN_YEAR
end_epoch_clipper = 34.5 * constants.JULIAN_YEAR
...
# Find JUICE flybys
closest_approaches_juice = find_closest_approaches(
    start_epoch_juice, start_orbital_phase if end_epoch_juice > start_orbital_phase else end_epoch_juice, 2.0e7)
...
time_step = 100.0
integrator_settings = propagation_setup.integrator.runge_kutta_4(time_step)
